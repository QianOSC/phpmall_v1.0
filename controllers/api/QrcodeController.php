...
class QrcodeController extends ApiController
{
    ...
    {
        $form = new PosterForm();
        return $this->asJson($form->poster('couponShare', \Yii::$app->request->get()));
    }

    public function actionCardShare()
    {
        $form = new PosterForm();
        return $this->asJson($form->poster('cardShare', \Yii::$app->request->get()));
    }
}
