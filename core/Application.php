...
trait Application
{
    ...
    protected function defineConstants()
    {
        ...
        define_once('APP_PLATFORM_MOBILE', 'mobile');
        define_once('APP_PLATFORM_WECHAT', 'wechat');
    ...
    public function getRole()
    {
        if (!$this->role) {
            ...
            } elseif ($userIdentity->is_operator == 1 || $userIdentity->is_supplier == 1) {
                // 员工
