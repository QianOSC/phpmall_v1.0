...
class Menus
{
    ...
    public static function getDefaultNav()
    {
        ...
        foreach ($mallMenus as &$menu) {
            $menu = self::setExtraMenu($menu, $pluginMenus, $platformMenus, false);
        }
        unset($menu);
        return $mallMenus;
    }
    ...
    public static function getMallMenus($isPluginMenus = false)
    {
        $mallMenus = [
            [
                ...
                'route' => '',
                'key' => 'statistics',
                'icon_0' => 'statics/img/mall/nav/statics.png',
            ...
            [
                ...
                'key' => 'app-manage',
                'route' => '',
                'icon_0' => 'statics/img/mall/nav/applets.png',
                'icon' => 'fab fa-weixin',
            ...
            [
                'name' => '店铺管理',
                'route' => '',
                'icon_0' => 'statics/img/mall/nav/mall-manage.png',
...
//                        'route' => 'mall/data-statistics/index',
                    ...
                    [
                        'name' => '供应商管理',
                        'route' => 'mall/supplier/index',
                        'action' => [
                            [
                                'name' => '供应商修改',

                                'route' => 'mall/supplier/edit',
                            ],
                            [
                                'name' => '供应商删除',
                                'route' => 'mall/supplier/destroy',
                            ],
                        ],
                    ],
                    [
                        'name' => '供应商订单',
                        'route' => 'mall/supplier/order',
                        'action' => [
                        ],
                    ],
                    [
            ...
            [
                'name' => '商品管理',
                'route' => 'mall/goods/index',
                'icon_0' => 'statics/img/mall/nav/goods.png',
                'icon' => 'fas fa-archive',
...
//                    [
            ...
            [
                'name' => '订单管理',
                'route' => 'mall/order/index',
                'icon_0' => 'statics/img/mall/nav/order.png',
...
//                    [
            ...
            [
                'name' => '用户管理',
                'route' => 'mall/user/index',
                'icon_0' => 'statics/img/mall/nav/user.png',
...
//                        'route' => 'mall/data-statistics/index',
            ...
            [
                'name' => '财务管理',
                'route' => '',
                'icon_0' => 'statics/img/mall/nav/finance.png',
                'icon' => 'fas fa-wallet',
...
//                    [
            ...
            [
                ...
                'icon_0' => 'statics/img/mall/nav/plugins.png',
                'icon' => 'fas fa-cubes',
            ...
            [
                'name' => '设置',
                'route' => '',
                'icon_0' => 'statics/img/mall/nav/setting.png',
                'icon' => 'fas fa-cogs',
