...
class ApiGoods extends Model
{
    ...
    public function getDetail()
    {
        ...
        $data = [
            ...
            'buy_goods_auth' => $goodsAuth->checkBuyAuth($this->goods),
            'sell_time' => $goodsAuth->getSellTime($this->goods),
            'is_finish_sell' => $goodsAuth->checkFinishSell($this->goods),
        ];
     ...
     * 获取会员价
     */
    protected function getGoodsMember($user = null)
    {
        return CommonGoodsMember::getCommon()->getGoodsMemberPrice($this->goods, $user);
    }
    ...
    private function getGoodsDetail()
    {
        ...
        $form->user = $this->user ? $this->user : \Yii::$app->user->identity;
