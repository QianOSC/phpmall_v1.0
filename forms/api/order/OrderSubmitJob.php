...
class OrderSubmitJob extends BaseJob implements JobInterface
{
    /** @var Mall $mall */
    public $mall;
    ...
    public function execute($queue)
    {
        ...
        \Yii::$app->setAppPlatform($this->platform);
        $this->setRequest();
        ...
        try {
            ...
            foreach ($data['mch_list'] as $mchItem) {
                ...
                $order->delivery_type = $this->delivery_time['status'];
                $order->delivery_time = $this->delivery_time['time'];
