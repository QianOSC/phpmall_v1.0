...
class VideoNumberEditForm extends Model
{
    ...
    public function save()
    {
        try {
            ...
            $this->accessToken = $this->getAccessToken()['accessToken'];
    ...
    {
        $data = $this->videoNumberSetting;
        $mp = new MpTplGet();
        $accessToken = $mp->getAccessToken($data['video_number_app_id'], $data['video_number_app_secret']);
