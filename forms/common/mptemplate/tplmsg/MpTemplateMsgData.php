...
class MpTemplateMsgData extends Model
{
    ...
    public function newOrderTpl($config, $params = array())
    {
        ...
        $remark = isset($params['total_pay_price']) ? "订单金额：" . $params['total_pay_price'] . " " : '';
        $result = [
    ...
    public function shareWithdrawTpl($config, $params = array())
    {
        ...
        $typeName = isset($params['type_name']) ? $params['type_name'] : '分销商';
        ...
        $result = [
            ...
            'data' => [
                'first' => [
                    'value' => sprintf('有%s申请提现，请及时处理', $typeName),
                    'color' => '#666666',
                ],
                'keyword1' => [
                    'value' => $params['time'],
