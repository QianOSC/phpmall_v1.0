...
class CatEditForm extends Model
{
    ...
    public function rules()
    {
        return [
            [['name', 'sort'], 'required'],
            [['parent_id', 'id', 'is_show', 'mch_id'], 'integer'],
            [['advert_open_type'], 'string', 'max' => 65],
            [['advert_params'], 'trim'],
            [['pic_url', 'big_pic_url', 'pic_ad', 'advert_pic', 'advert_url', 'status'], 'string'],
        ];
    }
    ...
    public function save()
    {
        ...
        try {
            if ($this->id) {
                ...
                $cat->mch_id = $this->mch_id ?: \Yii::$app->user->identity->mch_id;
