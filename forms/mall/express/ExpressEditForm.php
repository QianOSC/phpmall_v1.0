...
class ExpressEditForm extends Model
{
    ...
    public $kd100_t_height;
    public $kd100_t_width;

    public function rules()
    {
        return [
            [['name', 'province', 'city', 'district', 'address'], 'required'],
            [['id', 'express_id', 'is_sms', 'is_goods', 'is_goods_alias', 'kd100_t_height', 'kd100_t_width'], 'integer'],
            ...
            [['mobile', 'zip_code', 'template_size', 'company', 'customer_account', 'customer_pwd',
                'month_code', 'outlets_name', 'outlets_code', 'business_type', 'kd100_template', 'kd100_business_type'], 'default', 'value' => ''],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'kd100_t_height' => '快递100 模板 高度',
            'kd100_t_width' => '快递100 模板 宽度'
        ];
    }
