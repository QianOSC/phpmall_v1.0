...
abstract class BaseGoodsEdit extends Model
{
    ...
    public function rules()
    {
        return [
            ...
            [['use_attr', 'goods_num', 'virtual_sales', 'goods_weight', 'individual_share',
                ...
                'give_balance_type', 'limit_buy_status', 'limit_buy_value', 'min_number',
            ...
            [['goods_no', 'rebate', 'app_share_title', 'app_share_pic', 'attr_default_name',
                ...
                'buy_goods_auth', 'bar_code'], 'string'],
            [['forehead', 'id'], 'number'],
            [['cats', 'mchCats', 'services', 'cards', 'attr', 'attrGroups', 'member_price',
                'select_attr_groups', 'shareLevelList', 'plugin_data', 'coupons', 'send_type', 'sell_time'], 'safe'],
            [['virtual_sales', 'freight_id', 'is_level', 'is_level_alone', 'forehead', 'forehead_integral',
                ...
                'give_balance', 'shipping_id', 
		'is_setting_send_type', 'is_time', 
		'supplier_id'
		], 'default', 'value' => 0],
            ...
            [['limit_buy_value'], 'number', 'max' => 9999],
    ...
    protected function setGoods()
    {
        ...
        if ($goodsAuth->is_setting_send_type && $goodsWarehouse->type == 'goods') {
        ...
        $goods->supplier_id = $this->supplier_id;
        $res = $goods->save();
    ...
    protected function setAttr()
    {
        ...
        foreach ($this->newAttrs as $newAttr) {
            ...
            $goodsAttr->bar_code = isset($newAttr['bar_code']) ? $newAttr['bar_code'] : '';
     ...
     * @throws Exception
     */
    protected function setGoodsMemberPrice($goodsAttrId, $level, $price = 0)
    {
        if (!$price) {
            $price = 0;
        }
