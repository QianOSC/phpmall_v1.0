        ...
        try {
            ...
            while ($file_data = fgetcsv($cvs_file)) {
                ...
                if ($file_data[0] != '') {
                    ...
                    $arr['pic_url'] = $this->getNewData($file_data[1]);
                    $arr['sort'] = $this->getNewData($file_data[2]);
                    $arr['big_pic_url'] = $this->getNewData($file_data[3]);
                    $arr['advert_pic'] = $this->getNewData($file_data[4]);
                    $arr['advert_url'] = $this->getNewData($file_data[5]);
                    $arr['advert_open_type'] = $this->getNewData($file_data[6]);
                    $arr['advert_params'] = $this->getNewData($file_data[7]);
                    $arr['child'] = $this->getNewData($file_data[8]);
                    $data[$i] = $arr;
                }
            }
            fclose($cvs_file);
