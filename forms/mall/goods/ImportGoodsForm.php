        ...
        try {
            ...
            while ($file_data = fgetcsv($cvs_file)) {
                ...
                if ($file_data[0] != '') {
                    ...
                    $arr['pieces'] = $this->getNewData($file_data[14]);
                    $arr['forehead'] = $this->getNewData($file_data[15]);
                    $arr['give_integral'] = $this->getNewData($file_data[16]);
                    $arr['give_integral_type'] = $this->getNewData($file_data[17]);
                    $arr['forehead_integral'] = $this->getNewData($file_data[18]);
                    $arr['forehead_integral_type'] = $this->getNewData($file_data[19]);
                    $arr['accumulative'] = $this->getNewData($file_data[20]);
                    $arr['sign'] = $this->getNewData($file_data[21]);
                    $arr['app_share_pic'] = $this->getNewData($file_data[22]);
                    $arr['app_share_title'] = $this->getNewData($file_data[23]);
                    $arr['sort'] = $this->getNewData($file_data[24]);
                    $arr['confine_order_count'] = $this->getNewData($file_data[25]);
                    $arr['is_area_limit'] = $this->getNewData($file_data[26]);
                    $arr['area_limit'] = json_decode($this->getNewData($file_data[27]), true);
                    $arr['attr'] = json_decode($this->getNewData($file_data[28]), true);
                    $arr['is_quick_shop'] = $this->getNewData($file_data[29]);
                    $arr['is_sell_well'] = $this->getNewData($file_data[30]);
                    $arr['is_negotiable'] = $this->getNewData($file_data[31]);
                    $arr['shipping_id'] = $this->getNewData($file_data[32]);
