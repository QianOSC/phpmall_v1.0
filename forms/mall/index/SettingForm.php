...
class SettingForm extends Model
{
    ...
    public $t0_limit;
    public $t1_limit;
    public $t0_today_limit;
    public $t1_today_limit;
    public $time_tips;
    ...
    public function rules()
    {
        return [
            ...
            [['contact_tel', 'kdniao_mch_id', 'kdniao_api_key', 'member_integral_rule',
                ...
                'video_number_app_id', 'video_number_app_secret', 'video_number_share_title', 'kdniao_select_type',
                'video_number_user_1', 'video_number_user_2', 'kd100_yum', 't0', 't1', 't0_today', 't1_today', 't0_limit', 't1_limit', 't0_today_limit', 't1_today_limit', 'time_tips'], 'string'],
            [['over_time', 'delivery_time', 'after_sale_time', 'member_integral',
                ...
                'is_show_hot_goods', 'is_open','open_type','is_auto_open', 'is_video_number',
                'is_video_number_member', 'has_order_evaluate', 'order_evaluate_day'], 'integer'],
            [['name'], 'required',],
            ...
            [['good_negotiable', 'payment_type', 'send_type', 'business_time_type_day', 'business_time_type_week',
                'auto_business_time', 'quick_customize_params', 'quick_customize_new_params', 'send_type_desc', 'time_list', 'week_list', 'video_number_member_list', 'video_number_template_list', 'customer_service_list'], 'safe'],
    ...
    public function save()
    {
        ...
        try {
            ...
            foreach ($this->attributes as $k => $item) {
                ...
                if (in_array($k, ['good_negotiable', 'payment_type', 'send_type', 'business_time_type_week', 'business_time_type_day', 'quick_customize_new_params', 'send_type_desc', 'week_list', 'time_list', 'video_number_member_list', 'video_number_template_list', 'customer_service_list'])) {
