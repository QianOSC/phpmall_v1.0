...
class WxPlatformMsgForm extends Model
{
    ...
    public function getPlatformData()
    {
        ...
        try {
            $templateList = TemplateList::getInstance()->getTemplateByPlatform('wechat');
            $option['show_user'] = 1;
            $option['user_template'] = $templateList[0]['list'];
        ...
        return [
            ...
            'template_list' => [
                [
                    ...
                    'new_order_tpl' => '',
                    'pic_url' => $iconUrlPrefix . 'new_order_tpl_1.png',
                ],
                [
                    'name' => '分销商入驻申请通知',
