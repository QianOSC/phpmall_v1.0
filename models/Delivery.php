 ...
 * @property int $kd100_t_height 打印纸高度
 * @property int $kd100_t_width 打印纸宽度
 */
class Delivery extends ModelActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['mall_id', 'mch_id', 'express_id', 'is_sms', 'is_goods', 'is_delete', 'is_goods_alias', 'kd100_t_height', 'kd100_t_width'], 'integer'],
