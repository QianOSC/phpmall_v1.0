...
class Express
{
    ...
    {
        return json_decode(file_get_contents('statics/text/business.json'), true);
    }

    public static function getExpress()
    {
        $fileUrl = \Yii::$app->basePath . '/web/statics/text/express_list.json';
     ...
     * 快递100 提供的快递业务类型
     */
    public static function getKd100Business()
    {
        return [
            '安能快递' => [
                '次日达',
