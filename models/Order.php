 ...
 * @property int $delivery_type 配送时间类型
 * @property string $delivery_time 配送时间信息
 */
    ...
    public function rules()
    {
        return [
            ...
            [['total_price', 'total_pay_price', 'express_original_price', 'express_price', 'total_goods_price',
                ...
                'integral_deduction_price', 'back_price', 'delivery_type'], 'number'],
            ...
            [['name', 'customer_name', 'express', 'delivery_time'], 'string', 'max' => 65],
