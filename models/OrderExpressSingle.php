...
class OrderExpressSingle extends ModelActiveRecord
{
    ...
    {
        return [
            [['mall_id', 'order_id', 'express_code', 'ebusiness_id', 'order', 'is_delete', 'created_at', 'deleted_at'], 'required'],
            [['mall_id', 'order_id', 'is_delete', 'order_detail_id'], 'integer'],
