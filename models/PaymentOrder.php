 ...
 * @property int $pay_type 支付方式：1=微信支付，2=货到付款，3=余额支付，4=支付宝支付，5=百度支付，6=头条支付, 7=微信H5支付，8支付宝H5支付,9.现金支付 10.pos机支付
...
class PaymentOrder extends ModelActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'pay_type' => '支付方式：1=微信支付，2=货到付款，3=余额支付，4=支付宝支付，5=百度支付，6=头条支付, 7微信H5支付，8支付宝H5支付,9.现金支付 10.pos机支付',
            'title' => 'Title',
