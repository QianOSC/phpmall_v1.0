 ...
 * @property int $is_supplier 是否为供应商
...
class UserIdentity extends ModelActiveRecord
{
    ...
    {
        return [
            [['is_super_admin', 'is_admin', 'is_operator', 'member_level', 'is_supplier',
    ...
    {
        return $this->hasOne(MallMembers::className(), ['level' => 'member_level'])->andWhere(['mall_id' => \Yii::$app->mall->id, 'is_delete' => 0]);
    }
}
