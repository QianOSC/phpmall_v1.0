        ...
        <el-card v-loading="listLoading" class="box-card" shadow="never" style="border:0"
            ...
            <div class="table-body">
                ...
                <el-table
                    ...
                    <el-table-column prop="min_price" width="200" label="最低价"></el-table-column>
                    <el-table-column prop="goods_stock" label="库存" sortable="false" width="120">
                        <template slot-scope="scope">
                            <div v-if="scope.row.goods_stock > 0">{{scope.row.goods_stock}}</div>
                            <div v-else style="color: red;">售罄</div>
                        </template>
                    </el-table-column>
                    <el-table-column prop="created_at" width="350" label="活动时间">
                        <template slot-scope="scope">
                    ...
                    <el-table-column label="活动状态" width="120" prop="status_text">
                        <template slot-scope="scope">
                            <el-tag v-if="scope.row.status_text == 1" type="info">未开始</el-tag>
                            <el-tag v-else-if="scope.row.status_text == 2">进行中</el-tag>
                            <el-tag v-else-if="scope.row.status_text == 3" type="danger">已结束</el-tag>
                            <el-tag v-else-if="scope.row.status_text == 4" type="warning">已下架</el-tag>
                        </template>
                    </el-table-column>
                    <el-table-column
                        label="操作"
