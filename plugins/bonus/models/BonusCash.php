...
/**
 * This is the model class for table "{{%bonus_cash}}".
 * @property int $id
 ...
 */
class BonusCash extends \app\models\ModelActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return $this->hasOne(BonusCaptain::className(), ['user_id' => 'user_id']);
    }
