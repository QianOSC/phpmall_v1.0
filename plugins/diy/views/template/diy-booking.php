...
<style>
    ...
    .diy-booking .diy-component-preview .goods-underline-price {
        margin-left: 5px;
        white-space: nowrap;
        overflow: hidden;
        text-overflow: ellipsis;
                        ...
                        <div :style="cGoodsInfoStyle">
                            ...
                            <div flex="box:last cross:bottom">
                                ...
                                <div v-if="cShowBuyBtn" style="padding: 0 10px;">
                                    <el-button :style="cButtonStyle" v-if="data.buyBtnStyle===1" class="buy-btn"
                                               type="primary"
                                               size="small">{{data.buyBtnText}}
                                    </el-button>
                                    <el-button :style="cButtonStyle" v-if="data.buyBtnStyle===2" class="buy-btn"
                                               size="small">{{data.buyBtnText}}
                                    </el-button>
                                    <el-button :style="cButtonStyle" v-if="data.buyBtnStyle===3" class="buy-btn"
                                               type="primary"
                                               size="small" round>{{data.buyBtnText}}
                                    </el-button>
                                    <el-button :style="cButtonStyle" v-if="data.buyBtnStyle===4" class="buy-btn"
                                               size="small" round>{{data.buyBtnText}}
                                    </el-button>
                                </div>
                            </div>
