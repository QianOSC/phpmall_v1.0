...
?>
<style>
    .diy-exchange .diy-component-edit .goods-list {
        line-height: normal;
        flex-wrap: wrap;
    }

    .diy-exchange .diy-component-edit .goods-item,
    .diy-exchange .diy-component-edit .goods-add {
        width: 50px;
        height: 50px;
    ...
    .diy-exchange .diy-component-edit .goods-delete {
        position: absolute;
        top: -11px;
        right: -11px;
        width: 25px;
    ...
    .diy-exchange .diy-component-edit .goods-item:hover .goods-delete {
        visibility: visible;
    }

    /*-------------------- 预览部分 --------------------*/
    .diy-exchange .diy-component-preview .goods-list {
        flex-wrap: wrap;
        padding: 10px;
    }

    .diy-exchange .diy-component-preview .goods-item {
        position: relative;
    }

    .diy-exchange .diy-component-preview .goods-tag {
        position: absolute;
        top: 0;
        left: 0;
        width: 64px;
    ...
    .diy-exchange .diy-component-preview .goods-pic {
        width: 100%;
        height: 706px;
    ...
    .diy-exchange .diy-component-preview .goods-name {
        white-space: nowrap;
        overflow: hidden;
        text-overflow: ellipsis;
    }

    .diy-exchange .diy-component-preview .goods-cover-3-2 .goods-pic {
        height: 470px;
    }

    .diy-exchange .diy-component-preview .goods-list-2 .goods-pic {
        height: 343px;
    }

    .diy-exchange .diy-component-preview .goods-list--1 .goods-pic {
        width: 200px;
        height: 200px;
        margin-right: 20px;
    }

    .diy-exchange .diy-component-preview .goods-list--1 .goods-item {
        margin-bottom: 20px;
    }

    .diy-exchange .diy-component-preview .goods-list--1 .goods-item:last-child {
        margin-bottom: 0;
    }

    .diy-exchange .diy-component-preview .goods-name-static {
        white-space: normal;
        overflow: hidden;
        text-overflow: ellipsis;
        display: -webkit-box;
    ...
    .diy-exchange .diy-component-preview .goods-price {
        white-space: nowrap;
        overflow: hidden;
        text-overflow: ellipsis;
        color: #ff4544;
    ...
    .diy-exchange .diy-component-preview .goods-advance-timer {
        position: absolute;
        left: 0;
        right: 0;
        bottom: 0;
...
<template id="diy-exchange">
    <div class="diy-exchange">
                    ...
                    <div class="goods-item"
                        ...
                        <div :style="cGoodsInfoStyle">
                            <div class="goods-name" :class="data.listStyle===-1?'goods-name-static':''">
                                <template>
                                    <span class="plugin-name">礼品卡</span>
...
<script>
    Vue.component('diy-exchange', {
        template: '#diy-exchange',
        props: {
            value: Object,
        },
        data() {
