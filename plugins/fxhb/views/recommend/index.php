                    ...
                    <el-col :span="12">
                        <el-form-item label="推荐商品状态">
                            <el-switch :active-value="1" :inactive-value="0"
                                       v-model="form.fxhb.is_recommend_status"></el-switch>
                        </el-form-item>
                        <el-form-item v-if="form.fxhb.is_recommend_status" label="自定义推荐商品">
                            <el-switch :active-value="1" :inactive-value="0" v-model="form.fxhb.is_custom"></el-switch>
                            <span>{{form.fxhb.is_custom ? "最多添加20件商品" : "按商品列表排序显示前10件商品"}}</span>
                            <div v-if="form.fxhb.is_custom">
                                <draggable v-model="form.fxhb.goods_list" flex class="goods-list">
                                <div class="goods-item" v-for="(goods,goodsIndex) in form.fxhb.goods_list">
                                    <el-tooltip effect="dark" content="移除商品" placement="top">
                                        <el-button @click="deleteGoods(goodsIndex, 'fxhb')" circle
                                ...
                                <div v-if="form.fxhb.goods_list.length < goodsDialog.max" class="goods-add">
                                    <el-tooltip effect="dark" content="添加商品" placement="top">
                                        <el-button @click="showGoodsDialog('fxhb')"
    ...
    const app = new Vue({
        ...
        methods: {
            ...
            getSetting() {
                ...
                request({
                    params: {
                        r: 'plugin/fxhb/mall/recommend/index',
                    },
                    method: 'get',
                }).then(e => {
                    self.loading = false;
