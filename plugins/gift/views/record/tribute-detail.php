...
<div id="app">
    <el-card style="border:0" shadow="never" body-style="background-color: #f3f3f3;padding: 0 0;" v-loading="listLoading">
        <div slot="header" >
        <span style="color: #409EFF" @click="navigateBack">领取记录</span>
        /领取详情
        </div>
        <div class="card-body">
                ...
                <div class="taber">
                    <el-table
                                ...
                                <div class="good-detail">
                                        ...
                                        <div style="width: 170px;min-height: 50px">
                                            ...
                                            :title="item.name"
                                               style="font-size: 14px;line-height: 1.2;color:#74767b;margin: 0;">
                                                {{item.name}}</p>
                                            <p class="attr" style="margin: 0;" :title="item.attr">
                                                规格：
                                    ...
                                    <div flex="" style="padding:10px 10px;"
                                        ...
                                        <div style="width: 170px;min-height: 50px">
                                            ...
                                            <p class="attr" style="margin: 0;" :title="scope.row.detail[0].attr">
                                                规格：
                                                <el-tag size="small" class="tag">
                        ...
                        <el-table-column
                            ...
                            <template slot-scope="scope">
                                <div flex="">
                                    <image style="width: 50px; height: 50px" :src="scope.row.user.userInfo.avatar"></image>
                                    <div style="margin-left: 10px">
                                        <span>{{scope.row.user.nickname}}</span>
                                        <div>
                                            <img src="statics/img/mall/ali.png" v-if="scope.row.user.userInfo.platform == 'aliapp'" alt="">
                                            <img src="statics/img/mall/wx.png" v-else-if="scope.row.user.userInfo.platform == 'wxapp'" alt="">
                                            <img src="statics/img/mall/toutiao.png" v-else-if="scope.row.user.userInfo.platform == 'ttapp'" alt="">
                                            <img src="statics/img/mall/baidu.png" v-else-if="scope.row.user.userInfo.platform == 'bdapp'" alt="">
                                        </div>
                                    </div>
                                </div>
                            </template>
                                ...
                                <div flex="cross:center">
                                    <div flex="" class="gift-user">
                                        ...
                                        <div style="margin-left: 10px;">
                                            ...
                                            <div>
                                                <img src="statics/img/mall/ali.png" v-if="scope.row.turn_list.gift_user.platform == 'aliapp'" alt="">
                                                <img src="statics/img/mall/wx.png" v-else-if="scope.row.turn_list.gift_user.platform == 'wxapp'" alt="">
                                                <img src="statics/img/mall/toutiao.png" v-else-if="scope.row.turn_list.gift_user.platform == 'ttapp'" alt="">
                                                <img src="statics/img/mall/baidu.png" v-else-if="scope.row.turn_list.gift_user.platform == 'bdapp'" alt="">
                                            </div>
                                        </div>
                                    </div>
                                    <image class="left-image" :src="pic_url"></image>
                                    <div v-if="scope.row.turn_list.turn_num > 0" class="gift-user" style="text-align: center; line-height: 50px">
                                        转增{{scope.row.turn_list.turn_num}}人
                                    </div>
                                    <image class="left-image" v-if="scope.row.turn_list.turn_num > 0" :src="pic_url"></image>
                                    ...
                                    <image class="left-image" v-if="scope.row.turn_list.parent_user" :src="pic_url"></image>
                                    <div flex="" class="gift-user">
                                        <image class="av" :src="scope.row.turn_list.self_user.avatar"></image>
                                        <div style="margin-left: 10px;">
                                            <span class="name">{{scope.row.turn_list.self_user.nickname}}</span>
                                            <div>
                                                <img src="statics/img/mall/ali.png" v-if="scope.row.turn_list.self_user.platform == 'aliapp'" alt="">
                                                <img src="statics/img/mall/wx.png" v-else-if="scope.row.turn_list.self_user.platform == 'wxapp'" alt="">
                                                <img src="statics/img/mall/toutiao.png" v-else-if="scope.row.turn_list.self_user.platform == 'ttapp'" alt="">
                                                <img src="statics/img/mall/baidu.png" v-else-if="scope.row.turn_list.self_user.platform == 'bdapp'" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <el-table-column
                            ...
                            label="操作">
                            <template slot-scope="scope">
                                <el-button type="text" circle v-if="scope.row.giftOrder[0].order_id == 0 && scope.row.giftOrder[0].is_refund == 0" @click="refund(scope.row.id, scope.row)" size="mini">
            ...
            <div flex="box:last cross:center" class="bot">
...
<script>
    ...
    const app = new Vue({
        ...
        created() {
            this.search.gift_id = getQuery('gift_id');
            this.receive_page = getQuery('page');
            console.log(this.search.gift_id);
            this.request();
        },
