...
class PosterNewForm extends Model implements BasePoster
{
    ...
    public function get()
    {
        ...
        $class->goods = $integralMall->goods;

        $class->other = $integralMall;
        $class->extraModel = 'app\plugins\integral_mall\forms\api\poster\PosterCustomize';
        return $class->build();
    }
