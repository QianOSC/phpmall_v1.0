    ...
    <el-card shadow="never" style="border:0" body-style="background-color: #f3f3f3;padding: 10px 0 0;" v-loading="listLoading">
        ...
        <div class="table-body">
            ...
            <el-table :data="form" border style="width: 100%">
                ...
                <el-table-column prop="created_at" label="添加日期" width="280"></el-table-column>
    ...
    <el-dialog title="添加分类" :visible.sync="dialogSortAdd" width="30%">
        <el-form :model="sortAddForm" label-width="80px" :rules="sortAddFormRules" ref="sortAddForm">
            <el-form-item label="分类" prop="cat_list" size="small">
                <el-cascader style="width: 90%" v-model="sortAddForm.cat_list" :options="cats" :show-all-levels="false" change-on-select :props="defaultProps"></el-cascader>
            </el-form-item>
            <el-form-item label="排序" prop="sort" size="small">
                <el-input style="width: 90%" v-model="sortAddForm.sort"></el-input>
            </el-form-item>
        </el-form>
...
const app = new Vue({
    ...
    methods: {
        ...
        sortAddSubmit() {
            this.$refs.sortAddForm.validate((valid) => {
                if (valid) {
                    ...
                    request({
                        params: {
                            r: 'plugin/integral_mall/mall/cats/edit',
                        },
                        method: 'post',
                        data: para,
                    }).then(e => {
        ...
        sortSubmit(row) {
            ...
            request({
                params: {
                    r: 'plugin/integral_mall/mall/cats/edit-sort',
                },
                method: 'post',
                data: para,
            }).then(e => {
        ...
        destroy: function(column) {
            this.$confirm('确认删除该记录吗?', '提示', {
                ...
                request({
                    params: {
                        r: 'plugin/integral_mall/mall/cats/destroy',
                    },
                    data: { id: column.id },
                    method: 'post'
                }).then(e => {
        ...
        getList() {
            ...
            request({
                params: {
                    r: 'plugin/integral_mall/mall/cats/index',
                    page: this.page,
