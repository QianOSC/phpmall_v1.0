...
class MchForm extends Model
{
    ...
    public function getDetail()
    {
        ...
        try {
            ...
            $newDetail['is_open'] = $data['is_open'] ? (int)$data['is_open'] : 1;
            $newDetail['open_type'] = $data['open_type'] ? (int)$data['open_type'] : 1;
            $newDetail['week_list'] = $data['week_list'] ?: [];
            $newDetail['time_list'] = $data['time_list'] ?: [];
            $newDetail['is_auto_open'] = $data['is_auto_open'] ? (int)$data['is_auto_open'] : 1;
            $newDetail['auto_open_time'] = $data['auto_open_time'] ?: '';
