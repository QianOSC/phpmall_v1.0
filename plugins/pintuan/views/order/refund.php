...
<div id="app" v-cloak>
    <el-card shadow="never" style="border:0" body-style="background-color: #f3f3f3;padding: 10px 0 0;" v-loading="loading">
        ...
        <div slot="header">
            <span>售后订单</span>
            <app-export-dialog action_url="index.php?r=plugin/pintuan/mall/order/refund"
    ...
    new Vue({
        ...
        data() {
            return {
                search: {
                    time: null,
                    r: 'plugin/pintuan/mall/order/refund',
                    keyword: '',
                    keyword_1: '1',
                    date_start: '',
                    date_end: '',
        ...
        methods: {
            ...
            getList() {
                this.loading = true;
                loadList('plugin/pintuan/mall/order/refund').then(e => {
                    this.$message({
                        message: '请求成功',
                        type: 'success'
                    });
            ...
            pageChange(page) {
                this.loading = true;
                this.list = [];
                loadList('plugin/pintuan/mall/order/refund', page).then(e => {
                    this.loading = false;
                    this.list = e.list;
                    this.pagination = e.pagination;
                });
