...
/**
 * This is the model class for table "{{%region_cash}}".
 * @property int $id
 ...
 * @property RegionUser region
 * @property RegionUserInfo regionUser
 * @property User user
 */
class RegionCash extends \app\models\ModelActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return $this->hasOne(RegionUser::className(), ['user_id' => 'user_id']);
    }
