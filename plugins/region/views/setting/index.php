        ...
        <el-form :model="form" :rules="rules" label-width="200px" ref="form">
            <el-tabs v-model="activeName">
                <el-tab-pane label="基本设置" name="first">
                    <div class="form-body">
                        <el-form-item class="switch" label="区域代理" prop="is_region">
                        ...
                        <el-form-item class="input-rate" v-if="is_region == 1" prop="region_rate">
                            <template slot='label'>
                                <span>订单最大分红比例</span>
                                <el-tooltip effect="dark" content="订单分红比例*订单实付金额=可被所有代理瓜分的分红总金额"
                                        placement="top">
                        ...
                        <el-form-item v-if="is_region == 1" class="switch" label="申请成为代理" prop="apply_type">
                            <el-radio-group @change="tabType" v-model="form.apply_type">
                                <el-radio label="1">申请(填信息)需审核</el-radio>
                                <el-radio label="2">申请(不填信息)需审核</el-radio>
                            </el-radio-group>
                        </el-form-item>
                        <el-form-item v-if="is_region == 1" class="switch" label="显示申请协议" prop="showTreaty">
                            <el-switch v-model="showTreaty" :active-value="1" :inactive-value="0"></el-switch>
                        </el-form-item>
                        <el-form-item v-if="is_region == 1 && showTreaty == 1" class="switch" label="协议名称" prop="agreement_title">
                            <el-input size="small" style="width: 590px;" v-model="form.agreement_title" autocomplete="off"></el-input>
                        </el-form-item>
                        <el-form-item v-show="is_region == 1 && showTreaty == 1" class="switch" label="协议内容" prop="agreement_content">
                            <app-rich-text style="width: 590px;" v-model="form.agreement_content"></app-rich-text>
                        </el-form-item>
                        <el-form-item v-show="is_region == 1" class="switch" label="用户须知" prop="user_instructions">
                            <template slot='label'>
                                <span>用户须知</span>
                                <el-tooltip effect="dark" content="用户须知展示在代理分红页面"
                                        placement="top">
                                    <i class="el-icon-info"></i>
                                </el-tooltip>
                            </template>
                        ...
                        <el-form-item v-show="is_region == 1" class="switch" label="升级说明" prop="level_up_content">
                            <el-input type="textarea" style="width: 590px;" :rows="10" v-model="form.level_up_content">
                            </el-input>
                        </el-form-item>
                    </div>
                </el-tab-pane>
                <el-tab-pane v-if="is_region == 1" label="结算设置" name="second">
                    <div class="form-body">
                ...
                <el-tab-pane v-if="is_region == 1" label="页面自定义" name="three">
                    <div class="title">
                    ...
                    <div class="form-body">
                        <div flex="dir:left">
                            ...
                            <div>
                                <el-form-item class="required-icon" label="头部banner图片" prop="bg_url">
                    ...
                    <div class="form-body" style="padding: 40px;display: flex;">
                        <div class='left-setting-menu'>
                            ...
                            <el-form-item label-width="140px" :class='active_setting == "2" ? "active":""' @click.native='chooseSetting("2")' label="申请成为代理">
                            </el-form-item>
                            <el-form-item label-width="140px" :class='active_setting == "3" ? "active":""' @click.native='chooseSetting("3")' label="主页">
                            </el-form-item>
                            <el-form-item label-width="140px" :class='active_setting == "4" ? "active":""' @click.native='chooseSetting("4")' label="代理分红">
                            </el-form-item>
                        </div>
                        <div style='background-color: #F3F5F6;padding: 30px;border-radius: 10px;overflow-y: auto;' :class='active_setting == "1" ? "no-radius":""' flex="dir:left">
                            <div v-if='active_setting == "1"' class="item-img">
                                ...
                                <div class="enter" flex="dir:left">
                                    ...
                                    <div class="enter-item">
                                        ...
                                        <div>{{form.form.entry_bonus?form.form.entry_bonus:'区域代理'}}</div>
                                    </div>
                                </div>
                            </div>
                            <div v-if='active_setting == "2"' class="item-img">
                                ...
                                <div class="page_title">{{form.form.apply_title_text ? form.form.apply_title_text : '申请成为代理'}}</div>
                                <div class="apply_text">{{form.form.apply_text ? form.form.apply_text : '申请成为区域代理'}}</div>
                            </div>
                            <div v-if='active_setting == "3"' class="item-img">
                                ...
                                <div class="rate_text">{{form.form.rate ? form.form.rate : '分红比例'}}10%</div>
                                ...
                                <div class="cash_bonus all_bonus">{{form.form.all_bonus ? form.form.all_bonus : '累计分红'}}(元)</div>
                                <div class="menu-list enter" flex="main:center">
                                    <div class="enter-item">
                                        <img src="statics/img/plugins/region/bonus.png" alt="">
                                        <div>{{form.form.region?form.form.region:'代理分红'}}</div>
                                    </div>
                                    <div class="enter-item">
                            ...
                            <div v-if='active_setting == "4"' class="item-img">
                                ...
                                <div class="bouns_text">{{form.form.bouns ? form.form.bouns : '代理分红'}}(元)</div>
                                <div class="bonus_total_bonus_text">{{form.form.total_bonus_text ? form.form.total_bonus_text : '可提现分红'}}</div>
                                <div class="bonus_total_bonus_text bonus_cash_bonus_text">{{form.form.cash_bonus_text ? form.form.cash_bonus_text : '已提现分红'}}</div>
                                <div class="bonus_total_bonus_text bonus_loading_bonus_text">{{form.form.loading_bonus_text ? form.form.loading_bonus_text : '待打款分红'}}</div>
                                <div class="to_cash">{{form.form.to_cash ? form.form.to_cash : '我要提现'}}</div>
                            </div>
                        </div>
                        <div class="item-img" style="border: 0;width: 570px;margin-left: 20px;">
                            ...
                            <div style="height: 32px;margin-left: 40px;margin-bottom: 20px" flex="dir:left cross:center" v-if="active_setting == 2">
                                <div class="default">申请成为区域代理</div>
                                <app-image width="12px" height="12px" mode="aspectFill" :src="customize_pic"></app-image>
    ...
    const app = new Vue({
        ...
        data() {
            ...
            return {
                ...
                rules: {
                    is_region: [
                        { required: true, message: '请选择是否开启区域代理', trigger: 'change' }
                    ],
                    region_rate: [
                    ...
                    apply_type: [
                        { required: true, message: '请选择申请成为代理的条件', trigger: 'change' }
                    ],
                    become_type: [
                        { required: true, message: '请选择申请成为代理的条件', trigger: 'change' }
                    ],
                    ...
                    level_up_content: [
                        { required: true, message: '请填写升级说明', trigger: 'blur' }
                    ],
                    condition: [
