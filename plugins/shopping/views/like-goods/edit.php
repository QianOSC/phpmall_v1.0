...
<div id="app" v-cloak>
    <el-card v-loading="listLoading" class="box-card" shadow="never" style="border:0" body-style="background-color: #f3f3f3;padding: 10px 0 0;">
        <div slot="header">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item><span style="color: #409EFF;cursor: pointer" @click="$navigate({r:'plugin/shopping/mall/like-goods/index'})">想买好物圈</span></el-breadcrumb-item>
        ...
        <div class="table-body">
            ...
            <el-table :data="list" border style="width: 100%;margin-bottom: 15px" @selection-change="handleSelectionChange">
                    ...
                    <template slot-scope="scope">
                        <div flex="box:first">
                            ...
                            <div>
                                ...
                                <el-tag size="mini" v-for="item in scope.row.goodsWarehouse.cats" :key="item.id">{{item.name}}</el-tag>
                            </div>
                        </div>
                    </template>
                </el-table-column>
