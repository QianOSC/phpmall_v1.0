    ...
    <el-card shadow="never" style="border:0" body-style="background-color: #f3f3f3;padding: 10px 0 0;">
        <div slot="header">
            ...
            <el-form size="small" :inline="true" :model="search" style="float: right;margin-top: -5px;">
                <el-form-item>
                    <app-export-dialog action_url='index.php?r=plugin/stock/mall/cash/index' :field_list='exportList' :params="search" @selected="confirmSubmit">
                    </app-export-dialog>
                </el-form-item>
            </el-form>
        </div>
    ...
    const app = new Vue({
        ...
        methods: {
            ...
            loadData() {
                ...
                request({
                    params: {
                        r: 'plugin/stock/mall/cash/index',
            ...
            remark() {
                ...
                request({
                    params: {
                        r: 'plugin/stock/mall/cash/remark',
                    },
                    data: {
                        remark: this.content,
                        id: this.detail.id,
            ...
            contentConfirm(status,content) {
                ...
                request({
                    params: {
                        r: 'plugin/stock/mall/cash/cash-apply',
                    },
                    data: {
                        content: content,
                        id: this.detail.id,
