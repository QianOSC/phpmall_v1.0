...
//            ],
     ...
     */
    public function vipDiscount($mchItem, $useTempVip = false, $orderSubmitForm = null, $user = null)
    {
    ...
    public function getRules($plugins = ['advance', 'booking', 'exchange', 'gift', 'miaosha', 'pintuan', 'flash_sale', 'wholesale'])
    {
        $list['rules'] = [''];
...
EOF;
    ...
    {
        return [
            RemindInfo::TPL_NAME => RemindInfo::class,
        ];
    }
}
