...
use app\plugins\vip_card\forms\mall\UserExport;
...
class UserForm extends Model
{
    ...
    public function getList()
    {
        ...
        if ($this->flag == "EXPORT") {
            $queueId = CommonExport::handle([
                'export_class' => 'app\\plugins\\vip_card\\forms\\mall\\UserExport',
                'params' => [
                    'fieldsKeyList' => $this->fields,
                ],
                'model_class' => 'app\\plugins\\vip_card\\forms\\mall\\UserForm',
    ...
    public function search()
    {
        ...
        foreach ($list as $item) {
            ...
            $newItem['nickname'] = PlatformConfig::getInstance()->getPlatformText($item) . '（' . $item->nickname . '）';
            $newList[] = $newItem;
        }
