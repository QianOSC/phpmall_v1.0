        ...
        <div v-if="list" class="table-body">
            ...
            <el-table
                ...
                <el-table-column
                        label="赠送">
                    <template slot-scope="scope">
                        <app-ellipsis style="height: 20px;" v-if="scope.row.send_integral_num > 0" :line="1">赠送积分{{scope.row.send_integral_num}}</app-ellipsis>
                        <app-ellipsis style="height: 20px;" v-if="scope.row.send_balance > 0" :line="1">赠送余额{{scope.row.send_balance}}</app-ellipsis>
                        <app-ellipsis style="height: 20px;"  v-for="item in scope.row.coupons" :key="item.id" :line="1">赠送优惠券{{item.send_num}}张 {{item.name}}</app-ellipsis>
                        <app-ellipsis style="height: 20px;" v-for="item in scope.row.cards" :key="item.id" :line="1">赠送卡券{{item.send_num}}张 {{item.name}}</app-ellipsis>
                    </template>
                </el-table-column>
