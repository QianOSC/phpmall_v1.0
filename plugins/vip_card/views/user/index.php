    ...
    <el-card shadow="never" style="border:0" body-style="background-color: #f3f3f3;padding: 10px 0 0;">
        <div slot="header">
            ...
            <app-new-export-dialog-2
                ...
                action_url="plugin/vip_card/mall/user/index">
            </app-new-export-dialog-2>
        </div>
                ...
                <el-table-column prop="created_at" label="当前会员权益">
                    <template slot-scope="scope">
                        ...
                        <div v-if="scope.row.rights.all == 1" class="right-info" flex="dir:left cross:center">
                            ...
                            <div>
                                <div>全场自营商品{{scope.row.rights.discount == 0 ? '免费': scope.row.rights.discount + '折'}}</div>
                            </div>
                        </div>
                        <div v-else style="width: auto;" class="right-info right-about" flex="dir:left cross:center">
                            ...
                            <div flex="dir:left">
                                ...
                                <div>{{scope.row.rights.discount == 0 ? '免费': scope.row.rights.discount + '折'}}</div>
                            </div>
                        </div>
                    </template>
                </el-table-column>
