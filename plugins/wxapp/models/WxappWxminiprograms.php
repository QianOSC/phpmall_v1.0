...
/**
 * This is the model class for table "{{%wxapp_wxminiprograms}}".
 * @property int $id ID
 * @property int $mall_id 商城id
 * @property string $nick_name 微信小程序名称
 * @property string $token 平台生成的token值
 * @property string $head_img 微信小程序头像
 ...
 */
class WxappWxminiprograms extends \app\models\ModelActiveRecord
{
    use UpdateToken;
    ...
    {
        return [
            [['verify_type_info', 'is_show', 'idc', 'authorizer_expires', 'is_delete', 'mall_id',], 'integer'],
            [['func_info', 'domain'], 'string'],
            [['created_at', 'updated_at', 'deleted_at', 'mall_id'], 'required'],
