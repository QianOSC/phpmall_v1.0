    ...
    <div class="login" :style="{'background-image':'url('+login_bg+')'}">
        <div class="opacity" flex="cross:center main:center">
            <el-card class="box-card" shadow="always" :style="{'background-image':'url('+login_bg+')'}">
                <img v-if="user_type == 2" class="logo_x" :src="roleSetting.logo" alt="">
                <img v-else class="logo_x" :src="login_logo" alt="">
                ...
                <img class="logo_x" :src="roleSetting.logo" alt="">
                <!--
...
<script>
    const app = new Vue({
        ...
        data() {
            return {
                login_bg: passportBg ? passportBg : (_baseUrl + '/statics/img/admin/BG.jpg'),
