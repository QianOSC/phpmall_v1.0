    ...
    <div style="margin-top: 10px">
        <el-form ref="ruleForm" label-width="150px" :model="ruleForm" :rules="rules"
            ...
            <el-card shadow="never">
                ...
                <el-form-item v-if="ruleForm.print_type === ''" label="接口选择" prop="kdniao_select_type">
                ...
                <el-form-item v-if="ruleForm.print_type === 'kd100'" prop="kd100_yum" label="是否使用快递100云打印功能">
