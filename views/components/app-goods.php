...
Yii::$app->loadViewComponent('goods/app-goods-param');
                ...
                <el-tabs v-model="activeName" @tab-click="handleClick" :before-leave="leaveTab">
                    <el-tab-pane label="商品设置" name="first" v-if="is_basic == 1">
                        ...
                        <el-card v-if="is_cats === 1" shadow="never" class="mt-24">
                            ...
                            <el-row>
                                <el-col :xl="12" :lg="16">
                                    <el-form-item label="选择供应商" prop="express">
                                        <el-select size="small" v-model="ruleForm.supplier_id" filterable placeholder="请选择">
                                            <el-option v-for="item in supplier_list" :key="item.id" :label="item.name"
                        ...
                        <el-card shadow="never" class="mt-24" v-if="is_product_setting === 1">
                            ...
                            <el-row>
                                <el-col :xl="12" :lg="16">
                                    ...
                                    <app-goods-param v-if="has_goods_param" v-model="ruleForm"></app-goods-param>
                                </el-col>
                            </el-row>
                        </el-card>
                                ...
                                <el-col :xl="12" :lg="16">
                                    ...
                                    <el-form-item label="售价" prop="price" v-if="no_price === 1">
                                        <el-input type="number"
                                                  :disabled="is_info == 0 && sign != 'pintuan' && sign !== 'flash_sale' && sign !== 'wholesale' && sign !== 'exchange'"
                                    ...
                                    <template v-if="is_attr == 1">
                                        ...
                                        <el-form-item v-if="ruleForm.type == 'goods'">
                                            ...
                                            <div v-if="ruleForm.use_attr" style="width:150%;margin-top: 24px;">
                        ...
                        <el-card shadow="never" class="mt-24" v-if="is_purchase_settings === 1">
                            ...
                            <el-row>
                                <el-col :xl="12" :lg="16">
                                    <!-- 单商品设置发货方式 -->
                                    <el-form-item label="发货方式" prop="is_setting_send_type" v-if="is_setting_send_type && ruleForm.type == 'goods'">
                                        ...
                                        <div>
                                            <el-switch
                                                    v-model="ruleForm.is_setting_send_type"
                                                    :active-value="1"
                                                    :inactive-value="0">
                                            </el-switch>
                                            <el-checkbox-group v-model="ruleForm.send_type" :min="1" :max="send_type_desc.length" v-if="ruleForm.is_setting_send_type == 1">
                                    ...
                                    <!-- 销售时间 -->
                                    <el-form-item label="销售时间" prop="is_time" v-if="is_time">
                                        <div>
                                            <el-switch
                                                    v-model="ruleForm.is_time"
                                                    :active-value="1"
                                                    :inactive-value="0">
                                            </el-switch>
                                            <div v-if="ruleForm.is_time == 1">
                                                <el-date-picker
                                                        size="small"
                                                ...
                                                <div style="color: #CCCCCC">开启开售提醒，商品开售前5分钟会发消息提醒买家。
                                                    <el-button v-if="is_mch == 0" type="text" @click="$navigate({r:'mall/index/goods'}, true)">去设置</el-button>
                                                </div>
                                            </div>
                                        </div>
                                    </el-form-item>
                                    ...
                                    <el-form-item label="浏览和购买权限" prop="is_setting_show_and_buy_auth" v-if="is_show_and_buy_auth">
                                        <div class="limit-buy">
                                            <el-switch
                                                    v-model="ruleForm.is_setting_show_and_buy_auth"
                                                    :active-value="1"
                                                    :inactive-value="0">
                                            </el-switch>
                                            <el-form-item label="会员等级浏览权限" prop="show_goods_auth" label-width="140px"
                                                          v-if="ruleForm.is_setting_show_and_buy_auth == 1">
                                                <app-member-auth v-model="ruleForm.show_goods_auth"
                                                                 :members="memberLevel"></app-member-auth>
                                            </el-form-item>
                                            <el-form-item label="会员等级购买权限" prop="buy_goods_auth" label-width="140px"
                                                          v-if="ruleForm.is_setting_show_and_buy_auth == 1">
                                                <app-member-auth v-model="ruleForm.buy_goods_auth"
                                                                 :members="memberLevel"></app-member-auth>
                                            </el-form-item>
                                        </div>
                                    </el-form-item>
                                    ...
                                    <el-form-item label="起售" prop="min_number" v-if="is_min_number">
                                        <div flex="dir:left">
                                            <span class="box-grow-0" style="color:#606266">商品至少</span>
                                            <div style="width: 100%;margin:0 10px">
                                                <el-input oninput="this.value = this.value.replace(/[^0-9]/g, '');"
                                                          :min="1"
                                                          :max="9999"
                                                          placeholder="请输入1～9999之间的整数"
                                                          v-model="ruleForm.min_number">
                                                    <template slot="append">件</template>
                                                </el-input>
                                            </div>
                                            <span class="box-grow-0" style="color:#606266">起售</span>
                                        </div>
                                    </el-form-item>

                                    <el-form-item label="限购" prop="limit_buy_status" v-if="is_limit_buy">
                                        <div class="limit-buy">
                                            <el-switch
                                                    v-model="ruleForm.limit_buy_status"
                                                    :active-value="1"
                                                    :inactive-value="0">
                                            </el-switch>
                                            <el-form-item :label="sign == 'miaosha' ? '限购' : '终身限购'" prop="confine_count" label-width="90px"
                                                          v-if="ruleForm.limit_buy_status == 1">
                                                <div flex="dir:left">
                                                    <template v-if="ruleForm.confine_count > -1">
                                                        <div style="width: 100%;margin:0 10px 0 0">
                                                            <el-input oninput="this.value = this.value.replace(/[^0-9]/g, '');"
                                                                      :disabled="ruleForm.confine_count <= -1"
                                                                      :min="2"
                                                                      :max="9999"
                                                                      placeholder="请输入1～9999之间的整数"
                                            ...
                                            <el-form-item label="按周期限购" prop="limit_buy_value" label-width="90px"
                                                          v-if="ruleForm.limit_buy_status == 1 && sign != 'miaosha'">
                                                <div flex="dir:left">
                                                    <template v-if="ruleForm.limit_buy_value > -1">
                                                        <div style="width: 100%;margin:0 10px 0 0">
                                                            <el-input oninput="this.value = this.value.replace(/[^0-9]/g, '');"
                                                                      :disabled="ruleForm.limit_buy_value <= -1"
                                                                      :min="2"
                                                                      :max="9999"
                                                                      placeholder="请输入1～9999之间的整数"
                                                                      v-model="ruleForm.limit_buy_value">
                                                                <template slot="prepend">
                                                                    <el-select size="small" style="width: 120px" v-model="ruleForm.limit_buy_type" class="select">
                                                                        <el-option key="day" label="每天" value="day"></el-option>
                                                                        <el-option key="week" label="每周" value="week"></el-option>
                                                    ...
                                                    <el-checkbox style="margin-left: 5px;" @change="limitBuyValueChecked"
                                                                 v-model="ruleForm.limit_buy_value <= -1">无限制
                                                    </el-checkbox>
                                                </div>
                                            </el-form-item>
                                        </div>
                                    ...
                                    <el-form-item prop="freight_id"  v-if="ruleForm.type == 'goods' && is_shipping">
                                        ...
                                        <el-dialog title="选择运费" :visible.sync="freight.dialog" width="30%">
                                            <div class="input-item">
                                                <el-input size="small" placeholder="请输入运费名称" v-model="search.ssYF" clearable>
                                                    <el-button slot="append" icon="el-icon-search"></el-button>
                                                </el-input>
                                            </div>
                                            <el-card shadow="never" flex="dir:left" style="flex-wrap: wrap"
                                                     v-loading="freight.loading">
                                                <el-radio-group v-if="YFlist && YFlist.length" v-model="freight.checked">
                                                    <el-radio style="padding: 10px;" v-for="item in YFlist"
                        ...
                        <el-card shadow="never" class="mt-24" v-if="is_marketing === 1 && mch_id == 0">
                            ...
                            <el-row>
                                <el-col :xl="12" :lg="16">
                                    ...
                                    <el-form-item label="卡券发放" v-if="is_show == 1 && sign != 'mch' && sign != 'exchange'">
    ...
    Vue.component('app-goods', {
        ...
        data() {
            let ruleForm = {
                ...
                give_balance_type: 1,
                give_balance: 0,
                guarantee_pic: "<?= \Yii::$app->request->hostInfo .
                ...
                limit_buy_type: 'day',
                limit_buy_value: -1,
                is_setting_show_and_buy_auth: 0,
                show_goods_auth: '-1',
                buy_goods_auth: '-1',
                is_setting_send_type: 0,
                send_type: [],
                is_time: 0,
                sell_time: [],
                supplier_id: ''
            ...
            let rules = {
                ...
                unit: [
                    {required: false, message: '请输入商品单位', trigger: 'change'},
                ...
                min_number: [
                    {
                        type: 'integer', validator: (rule, value, callback) => {
                            if (value < 1) {
                                callback('最少起售数量为1');
                            }
                            if (value > max) {
                                callback('最大起售数量为' + max);
                            }
                            callback();
                        }, trigger: 'change'
                    }
                ...
                limit_buy_value: [
                    {
                        type: 'integer', validator: (rule, value, callback) => {
                            if (value > -1 && value < 1) {
                                callback('按周期限购数量最少为1');
                            }
                            if (value > max) {
                                callback('按周期限购数量最大为' + max);
                            }
                            callback();
                        }, trigger: 'change'
                    }
        ...
        computed: {
            YFlist(){
                if(this.search.ssYF) {
                    return this.freight.list.filter(item => {
                       return item.name.indexOf(this.search.ssYF) !== -1;
                    });
                } else {
        ...
        methods: {
            leaveTab(activeName) {
                ...
                if(activeName == 'four' && self.sign == 'wholesale') {
                    let pass = true;
                    console.log(self.cForm.price)
                    if(self.cForm.use_attr == 0) {
                        if(self.cForm.price < 0 || self.cForm.price === '') {
                            pass = false;
                        }
                        console.log(pass)
                    }else {
                        self.ruleForm.attr.map(item => {
            ...
            store(formName) {
                ...
                try {
                    if(self.sign == 'wholesale') {
                        self.cForm.price = self.ruleForm.price;
                        self.cForm.rise_num = self.form.rise_num;
                        self.cForm.wholesale_rules = [];
                        for(let item of self.form.wholesale_rules) {
                            if(item.num && item.discount) {
                                self.cForm.wholesale_rules.push(item)
                            }
                        }
                        self.cForm.rules_status = self.form.rules_status;
                        self.cForm.wholesale_type = self.form.wholesale_type;
                        if(!(self.cForm.rise_num > 0)) {
                            throw new Error('请正确填写起批数量');
                        }
                        if(self.cForm.rules_status == 1) {
                            if(+self.cForm.wholesale_rules[0].num < +self.cForm.rise_num ) {
                                throw new Error('一阶梯数量须大于等于起批数量');
                            }
                            if(!self.form.wholesale_rules[0].discount || !self.form.wholesale_rules[0].num) {
                                throw new Error('请填写一阶梯优惠');
                            }
                            for(let i in self.form.wholesale_rules) {
                                if((self.form.wholesale_rules[i].discount && !self.form.wholesale_rules[i].num) || (!self.form.wholesale_rules[i].discount && self.form.wholesale_rules[i].num)) {
                                    throw new Error('请填写完善优惠信息');
                                }
                            }
                            if(self.cForm.wholesale_rules.length == 2) {
                                if(!(+self.cForm.wholesale_rules[0].num < +self.cForm.wholesale_rules[1].num)) {
                                    throw new Error('高阶梯起批数量须大于低阶梯');
                                }
                                if(self.cForm.wholesale_type== 1 && !(+self.cForm.wholesale_rules[0].discount < +self.cForm.wholesale_rules[1].discount)) {
                                    throw new Error('高阶梯优惠力度须大于低阶梯');
                                }
                                if(self.cForm.wholesale_type== 0 && !(+self.cForm.wholesale_rules[0].discount > +self.cForm.wholesale_rules[1].discount)) {
                                    throw new Error('高阶梯优惠力度须大于低阶梯');
                                }
                            }
                            if(self.cForm.wholesale_rules.length == 3) {
                                let firstNum = +self.cForm.wholesale_rules[0].num;
                                let secNum = +self.cForm.wholesale_rules[1].num;
                                let thirdNum = +self.cForm.wholesale_rules[2].num;
                                let firstDiscount = +self.cForm.wholesale_rules[0].discount;
                                let secDiscount = +self.cForm.wholesale_rules[1].discount;
                                let thirdDiscount = +self.cForm.wholesale_rules[2].discount;
                                if(!(firstNum < secNum && firstNum < thirdNum && secNum < thirdNum)) {
                                    throw new Error('高阶梯起批数量须大于低阶梯');
                                }
                                if(self.cForm.wholesale_type== 1 && !(firstDiscount < secDiscount && firstDiscount < thirdDiscount && secDiscount < thirdDiscount)) {
                                    throw new Error('高阶梯优惠力度须大于低阶梯');
                                }
                                if(self.cForm.wholesale_type== 0 && !(firstDiscount > secDiscount && firstDiscount > thirdDiscount && secDiscount > thirdDiscount)) {
                                    throw new Error('高阶梯优惠力度须大于低阶梯');
                                }
                            }
                        }
                    }else if(self.sign === 'exchange' && !self.library_id) {
                        throw new Error('请选择兑换码库');
                    }

                    if(self.cForm.param_content && self.cForm.param_content.length){
                        let s = self.cForm.param_content.some((item) => {
                    ...
                    if (self.sign === 'pintuan' && self.cForm.group_list.length === 0) {
                        this.$confirm('该商品未添加阶梯团, 将无法在小程序端展示,是否继续', '提示', {
                          confirmButtonText: '保存',
                          cancelButtonText: '继续编辑',
                          type: 'warning'
                        }).then(() => {
                          self.handleSubmit(formName, isZero);
                        }).catch(() => {
                        });
                        return;
                    }
            ...
            getDetail(id, url = '') {
                ...
                request({
                    ...
                    if (e.data.code == 0) {
                        ...
                        if (detail.coupons && detail.coupons.length > 0) {
                            let coupons = [];
            ...
            handleClick(tab, event) {
                this.$emit('change-tabs', tab.name, this.ruleForm);
            },
            // 获取商品服务
            getServices() {
                let self = this;
            ...
            itemChecked(type) {
                this.ruleForm.confine_count = type ? -1 : 1;
            },
            ...
            async getPluginCon() {
                ...
                if (e.data.code === 0) {
                    let {
                        is_ecard, ecard_url, is_vip_card, is_show_and_buy_auth, is_setting_send_type, is_time
                    } = e.data.data;
                    this.is_ecard = is_ecard;
                    this.ecard_url = ecard_url;
                    this.is_svip = is_vip_card;
                    this.is_show_and_buy_auth = is_show_and_buy_auth;
                    this.is_setting_send_type = is_setting_send_type;
            ...
            limitBuyValueChecked(type) {
                this.ruleForm.limit_buy_value = type ? -1 : 1;
            },
            async getSendType() {
                if (this.is_setting_send_type === 0) {
                    return ;
                }
                const e = await request({
                    params: {
                ...
                if (e.data.code === 0) {
                    let send_type_desc = e.data.data;
                    if (this.is_mch == 1) {
                        for (let i = 0; i < send_type_desc.length; i++) {
                            if (send_type_desc[i].key === 'city') {
                                this.$delete(send_type_desc, i);
                            }
                        }
                    }
                    this.send_type_desc = send_type_desc;
                }
            },
            ...
            getSuppliers(){
                ...
                request({
                    params: {
                        r: 'mall/supplier/list'
                    },
                }).then(e => {
                    if (e.data.code == 0) {
                        if (e.data.data) {
                            this.supplier_list = e.data.data.supplier_list;
                        }
                    }
