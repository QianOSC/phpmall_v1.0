...
<template id="app-plugins-banner">
...
<script>
    Vue.component('app-plugins-banner', {
        template: '#app-plugins-banner',
        props: {
            url: String,
            title: {
                type: Boolean,
        ...
        methods: {
            ...
            confirm() {
                this.$emit('concat_list', this.checkedAttachments);
