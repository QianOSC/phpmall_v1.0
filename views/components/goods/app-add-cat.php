...
<template id="app-add-cat">
    <div class="app-add-cat">
        ...
        <el-dialog :title="title" width="1100px" :visible.sync="dialogVisible" :append-to-body="appendToBody">
            <div class="app-add-cat">
                            ...
                            <div class="app-goods-cat-list active">
                                <div :class="{'active': current1 == option.value ? true : false}" class="cat-item"
                                    ...
                                    <el-checkbox @change="optionClick(option)" v-model="option.checked"
                                             :label="option.value" size="mini"  :disabled="option.checked ? false: maxDisabled">
                ...
                <div class="tag-box" v-if="cats.length > 0">
                    <el-tag type="warning" class="tag-item" @close="deleteCat(item, index)" closable
    ...
    Vue.component('app-add-cat', {
        ...
        watch: {
            'cats'() {
                ...
                this.maxDisabled =  this.cats.length >= this.selectMax;
            }
        },
        data() {
            return {
