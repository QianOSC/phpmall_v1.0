            ...
            <el-form label-width="130px"
                ...
                <template v-if="order.send_type == 0 || order.send_type == 1">
                    ...
                    <el-form-item label="快递单号" prop="express_no" class="express-no" v-if="express.is_express == 1">
                        ...
                        <el-button v-if="adminPrintTemplate" type="info" size="small" @click="adminPrint('preview')" plain>打印预览</el-button>
                        <el-button v-if="adminPrintTemplate" type="info" size="small" @click="adminPrint('design')" plain>打印设计</el-button>
                    </el-form-item>
                    <!--售后发货应该用插槽的方式-->
...
<script>
    Vue.component('app-send', {
        ...
        methods: {
            ...
            expressSend() {
                ...
                if (self.send_type === 'change') {
                    ...
                    self.express = {
                        ...
                        mch_id: self.order.mch_id,
                        express_content: '',
                        express: self.order.last_express ? self.order.last_express : ''
                    };
                }
            },
            getExpressData() {
            ...
            adminPrint(type = 'design') {
                const self = this;
                try {
                    var LODOP = getLodop();
                    var imgbase64 = this.adminPrintTemplate;
                    LODOP.PRINT_INIT("");
            ...
            getPrint(e) {
                ...
                request({
                    params: {
                        ...
                        order_detail_ids: JSON.stringify(this.getOrderDetailId()),
                    },
                    method: 'get',
                }).then(e => {
                    e.visible = false;
                    ...
                    if (e.data.code == 0) {
                        ...
                        let {LogisticCode, imgBase64} = e.data.data.Order;
                        this.adminPrintTemplate = imgBase64;
                        this.express.express_no = LogisticCode;
