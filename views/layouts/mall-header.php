...
<template id="mall-header">
    <div>
        <header class="mall-header" flex="box:last">
            ...
            <el-menu class="menu-box" mode="horizontal" menu-trigger="click">
                ...
                <el-menu-item v-if="mch_id == 0" @click="navigateClick({r: 'admin/cache/clean', '_layout': 'mall'})" index="4">缓存
                </el-menu-item>
