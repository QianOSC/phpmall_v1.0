    ...
    <el-card shadow="never" style="border:0" class="box-card" body-style="background-color: #f3f3f3;padding: 10px 0 0;"
        ...
        <div class="form-body">
            <el-form :model="ruleForm" :rules="rules" size="small" ref="ruleForm" label-width="120px">
                ...
                <el-form-item prop="pic_ad">
                    <template slot='label'>
                        <span>分类展示图</span>
                        <el-tooltip effect="dark" content="显示在商品详情页面"
                                    placement="top">
                            <i class="el-icon-info"></i>
                        </el-tooltip>
                    </template>
                    <app-attachment :multiple="false" :max="1" v-model="ruleForm.pic_ad">
                        <el-tooltip effect="dark" content="建议宽度750" placement="top">
                            <el-button style="margin-bottom: 10px;" size="mini">选择文件</el-button>
                        </el-tooltip>
                    </app-attachment>
                    <app-gallery :url="ruleForm.pic_ad" :show-delete="true"
                                 @deleted="ruleForm.pic_ad = ''"
                                 width="80px" height="80px">
                    </app-gallery>
                </el-form-item>
