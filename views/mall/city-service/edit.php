        ...
        <div class="form-body">
            <el-form :model="ruleForm" :rules="rules" size="small" ref="ruleForm" label-width="150px">
                ...
                <template v-if="ruleForm.distribution_corporation == 3">
                  <el-form-item label="订单来源" prop="outer_order_source_desc">
                    <el-select v-model="ruleForm.outer_order_source_desc" filterable placeholder="请选择">
                      <el-option
                  ...
                  <el-form-item label="配送服务" prop="delivery_service_code">
                    <el-select v-model="ruleForm.delivery_service_code" filterable placeholder="请选择">
                      <el-option
                ...
                <el-form-item label="模拟测试" prop="is_debug">
                    <el-switch
                    ...
                    <span style="color: #ff4544">注意！正式环境下请关闭此开关，开启后可进行模拟下单</span>
                </el-form-item>
        ...
        data() {
            return {
                ...
                rules: {
                    ...
                    outer_order_source_desc: [
                        {required: true, message: '订单来源', trigger: 'change'},
                    ],
                    delivery_service_code: [
                        {required: true, message: '配送服务', trigger: 'change'},
                    ],
                },
                btnLoading: false,
                loading: false,
                ...
                outer_order_source_desc_list: [
                    { value:101, label: '美团' },
                    { value:102, label: '饿了么' },
                    { value:103, label: '京东到家' },
                    { value:201, label: '商家web网站' },
                    { value:202, label: '商家小程序-微信' },
                    { value:203, label: '商家小程序-支付宝' },
                    { value:204, label: '商家APP' },
                    { value:205, label: '商家热线' },
                    { value:'其它', label: '其它' },
                ],
                delivery_service_code_list: [
                    { value: 4002, label: '飞速达' },
                    { value: 4011, label: '快速达' },
                    { value: 4012, label: '及时达' },
                    { value: 4013, label: '集中送' },
                    { value: 4031, label: '跑腿-帮送' },
                    { value: 100001, label: '光速达-45' },
                    { value: 100000, label: '光速达-40' },
                    { value: 100002, label: '光速达-50' },
                    { value: 100003, label: '光速达-55' },
                    { value: 100004, label: '快速达-7590' },
                    { value: 100005, label: '快速达-6090' },
                    { value: 100006, label: '及时达-新' },
                ]
            };
        },
        methods: {
