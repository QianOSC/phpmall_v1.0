            ...
            <el-tabs v-model="activeName">
                <el-tab-pane label="基础设置" name="first">
                    <div class="form-body">
                        ...
                        <el-form-item label="赠送规则" prop="use_obtain">
                            <el-radio v-model="form.use_obtain" label="1">使用后赠送一张相同优惠券</el-radio>
                            <el-radio v-model="form.use_obtain" label="0">使用不赠送优惠券</el-radio>
                        </el-form-item>
