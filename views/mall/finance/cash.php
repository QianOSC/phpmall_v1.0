    ...
    <el-card shadow="never" style="border:0" body-style="background-color: #f3f3f3;padding: 10px 0 0;">
        ...
        <div class="table-body">
            ...
            <el-table :data="list" size="small" border v-loading="loading" style="margin-bottom: 15px">
                ...
                <el-table-column label="基本信息" width="140px">
                    <template slot-scope="scope">
                            <app-image mode="aspectFill" :src="scope.row.user.avatar" style="float: left;margin-right: 10px"></app-image>
                        <div>{{scope.row.user.nickname}}</div>
                        <img with="24px" height="24px" :src="scope.row.user.platform_icon" alt="">
                        <el-tooltip :content="'商户信息:' + scope.row.shop_name" placement="top" v-if="scope.row.shop_name">
                            <div style="display: -webkit-box;height:25px;line-height: 25px;-webkit-box-orient: vertical;-webkit-line-clamp: 1;">商户信息:{{scope.row.shop_name}}</div>
                        </el-tooltip>
                    </template>
                </el-table-column>
