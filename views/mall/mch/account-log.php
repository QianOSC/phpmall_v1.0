            ...
            <div>
                ...
                <div style="float: right;margin: -5px 0">
                    <app-new-export-dialog-2
                        ...
                        action_url="mall/mch/account-log">
                    </app-new-export-dialog-2>
                </div>
            </div>
        </div>
            ...
            <el-table :data="form" border style="width: 100%" v-loading="listLoading">
                ...
                <el-table-column label="金额(元)" width="150">
                    <template slot-scope="scope">
                        <div style="font-size: 18px;color: #68CF3D" v-if="scope.row.type == 1">+{{scope.row.money}}
                        </div>
                        <div style="font-size: 18px;color: #F6AA5A" v-if="scope.row.type == 2">-{{scope.row.money}}
                        </div>
                    </template>
                </el-table-column>
