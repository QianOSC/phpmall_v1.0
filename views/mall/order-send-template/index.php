                        ...
                        <div style="height: 308px;border: 1px solid #ebeef5;padding:16px" flex="">
                            ...
                            <div style="width: 20%; height: 100%;">
                                ...
                                <p style="width:170px;margin-bottom: 30px;" flex="main:left">
                                 ...
                                 <p style="width:170px;margin-bottom: 30px;" flex="main:left">
                                    单价：
                                    <span :class="global.goodsInf.unitPrice ? 'blue-text' : 'decoration'">{{global.goodsInf.unitPrice  | conversion}}</span>
                                </p>
                                <p style="width:170px;margin-bottom: 30px;" flex="main:left">
                                    数量：
                    ...
                    <template v-if="edit">
                        ...
                        <el-form label-width="125px">
                            ...
                            <div style="margin-bottom: 25px;" class="goodsInf" v-if="show === 3">
                                ...
                                <el-checkbox v-model="goodsInf.unitPrice" label="单价"></el-checkbox>
                        ...
                        <div id="canvas"
                            ...
                            <div id="invoice"
                                ...
                                fontSize: headline.font / (4/3) + 'px',height: '50px',lineHeight: '50px', letterSpacing: headline.space / (4/3)+'px',backgroundColor: `${show === 0? '#ecf4ff' : '#ffffff'}`, borderBottom: `${!order.date && !order.time && !order.orderNumber ? '1px solid #000000' : 'none'}`}"
                                    ...
                                    <div flex="cross:center main:center" style="width: 42%;height: 50px;border-left: 1px solid #000000;text-align: center">
                                        <img style="width: 180px; height: 34px;line-height: 50px;" src="statics/img/mall/order/bar-code.png">
                                    </div>
                                </div>
                                <div
                                ...
                                <div @click="showTab(3)"
                                    ...
                                    <div style="display: flex;border-bottom:1px solid #000000;position: relative;left: -0.5px;"
                                         v-if="goodsInf.serial || goodsInf.name || goodsInf.attr || goodsInf.number || goodsInf.univalent || goodsInf.article_number || goodsInf.unit || goodsInf.unitPrice">
                                        ...
                                        <div  style="display: flex;min-width: 0;-webkit-box-flex: 1;flex-grow: 1;flex-shrink: 1;" v-if="goodsInf.name || goodsInf.attr || goodsInf.unitPrice">
                                            <div :style="{width: goodsInf.name && goodsInf.attr && goodsInf.unitPrice ? '50%' : goodsInf.name && (!goodsInf.attr || !goodsInf.unitPrice) ? '75%' : '100%'}"  v-if="goodsInf.name" style="min-width: 0;flex-grow: 1;flex-shrink: 1;-webkit-box-flex: 1;border-left: 1px solid #000000;height: 30px;line-height: 30px;padding-left: .5%;font-size:10px;">商品名称
                                            </div>
                                            <div :style="
                                     {
                                         width: goodsInf.name && goodsInf.attr && goodsInf.unitPrice ? '25%' : !goodsInf.name && goodsInf.attr && goodsInf.unitPrice  ? '50%' : goodsInf.name && goodsInf.attr && !goodsInf.unitPrice ? '50%' : '100%'
                                         }" v-if="goodsInf.attr" style="min-width: 0;flex-grow: 1;flex-shrink: 1;-webkit-box-flex: 1;border-left: 1px solid #000000;height: 30px;line-height: 30px;padding-left: 0.5%;font-size:10px;">规格
                                            </div>
                                            <div :style="{width: goodsInf.name && goodsInf.attr && goodsInf.unitPrice ? '25%' : !goodsInf.name && goodsInf.attr && goodsInf.unitPrice ? '50%' : goodsInf.name && !goodsInf.attr && goodsInf.unitPrice ? '50%' : '100%'}"  v-if="goodsInf.unitPrice" style="min-width: 0;flex-grow: 1;flex-shrink: 1;-webkit-box-flex: 1;border-left: 1px solid #000000;height: 30px;line-height: 30px;padding-left: 0.5%;font-size:10px;">单价
                                            </div>
                                        </div>
                                    ...
                                    <div style="display: flex;border-bottom: 1px solid #000000;position: relative;left: -0.5px;"
                                       ...
                                       <div style="display: flex;min-width: 0;-webkit-box-flex: 1;flex-grow: 1;flex-shrink: 1;" v-if="goodsInf.name || goodsInf.attr || goodsInf.unitPrice">
                                           <div :style="{width: goodsInf.name && goodsInf.attr && goodsInf.unitPrice ? '50%' : goodsInf.name && (!goodsInf.attr || !goodsInf.unitPrice) ? '75%' : '100%'}" style="min-width: 0;flex-grow: 1;flex-shrink: 1;-webkit-box-flex: 1;word-wrap: break-word;border-left: 1px solid #000000;font-size:10px;padding: 10px 10px 10px 0.5%;position: relative"
                                                v-if="goodsInf.name">
                                               <span>男士羊毛衫</span>
                                           </div>
                                           <div :style="
                                     {
                                         width: goodsInf.name && goodsInf.attr && goodsInf.unitPrice ? '25%' : !goodsInf.name && goodsInf.attr && goodsInf.unitPrice  ? '50%' : goodsInf.name && goodsInf.attr && !goodsInf.unitPrice ? '50%' : '100%'
                                         }" style="min-width: 0;flex-grow: 1;flex-shrink: 1;-webkit-box-flex: 1;word-wrap: break-word;border-left: 1px solid #000000;font-size:10px;padding: 10px 10px 10px 0.5%;position: relative"
                                                v-if="goodsInf.attr">
                                            <span style="position: relative;transform:translate(-50%,-50%);width: calc(100% - 20px);word-wrap: break-word;"
                                            >默认</span>
                                           </div>
                                           <div :style="{width: goodsInf.name && goodsInf.attr && goodsInf.unitPrice ? '25%' : !goodsInf.name && goodsInf.attr && goodsInf.unitPrice ? '50%' : goodsInf.name && !goodsInf.attr && goodsInf.unitPrice ? '50%' : '100%'}" style="min-width: 0;flex-grow: 1;flex-shrink: 1;-webkit-box-flex: 1;word-wrap: break-word;border-left: 1px solid #000000;font-size:10px;padding: 10px 10px 10px 0.5%;position: relative"
                                                v-if="goodsInf.unitPrice">
                                            <span style="position: relative;transform:translate(-50%,-50%);width: calc(100% - 20px);word-wrap: break-word;"
                                            >￥10</span>
                                           </div>
                        ...
                        <el-table-column
                            ...
                            <template slot-scope="scope">
                                <el-switch v-model="scope.row.is_default"
                                           :active-value="1"
                                           :inactive-value="0"
                                           @change="handleDefault(scope.row)"></el-switch>
                            </template>
                        </el-table-column>
            ...
            <div v-for="(item) in printData"
                ...
                <div id="invoice"
                   ...
                   <div style="display: inline-block;position: relative;white-space: nowrap;width: 100%;height: 50px">
                       ...
                       <div style="width: 42%;height: 50px;border-left: 1px solid #000000;padding: 8px 0;text-align: center; box-sizing: border-box;display: inline-block;position: absolute;right: 0;">
                    ...
                    <div style="width: 100%;box-sizing:border-box;">
                        <div style="display: flex;border-bottom:1px solid #000000;width: 100%;position: relative;left: -0.5px;"
                            ...
                            <div :style="tableWidth" style="display: flex;" v-if="printPar.goodsInf.name || printPar.goodsInf.attr || printPar.goodsInf.unitPrice">
                                <div style="min-width: 0;flex-grow: 1;flex-shrink: 1;-webkit-box-flex: 1;width: 60%;border-left: 1px solid #000000;box-sizing:border-box;height: 30px;line-height: 30px;padding-left: 10px;font-size:10px;"
                                     :style="{width: printPar.goodsInf.name && printPar.goodsInf.attr && printPar.goodsInf.unitPrice ? '50%' : printPar.goodsInf.name && (!printPar.goodsInf.attr || !printPar.goodsInf.unitPrice) ? '75%' :'100%'}"
                                ...
                                <div style="min-width: 0;flex-grow: 1;flex-shrink: 1;-webkit-box-flex: 1;width: 40%;border-left: 1px solid #000000;box-sizing:border-box;height: 30px;line-height: 30px;padding-left: .5%;font-size:10px;"
                                     :style="
                                     {
                                         width: printPar.goodsInf.name && printPar.goodsInf.attr && printPar.goodsInf.unitPrice ? '25%' : !printPar.goodsInf.name && printPar.goodsInf.attr && printPar.goodsInf.unitPrice  ? '50%' : printPar.goodsInf.name && printPar.goodsInf.attr && !printPar.goodsInf.unitPrice ? '50%' : '100%'
                                         }"
                                     v-if="printPar.goodsInf.attr">规格
                                </div>
                                <div style="min-width: 0;flex-grow: 1;flex-shrink: 1;-webkit-box-flex: 1;width: 60%;border-left: 1px solid #000000;box-sizing:border-box;height: 30px;line-height: 30px;padding-left: 10px;font-size:10px;"
                                     :style="{width: printPar.goodsInf.name && printPar.goodsInf.attr && printPar.goodsInf.unitPrice ? '25%' : !printPar.goodsInf.name && printPar.goodsInf.attr && printPar.goodsInf.unitPrice ? '50%' : printPar.goodsInf.name && !printPar.goodsInf.attr && printPar.goodsInf.unitPrice ? '50%' : '100%'}"
                        ...
                        <div v-for="good in item.detail"
                           ...
                           <div :style="tableWidth" style="display: flex;" v-if="printPar.goodsInf.name || printPar.goodsInf.attr || printPar.goodsInf.unitPrice">
                               <div style="min-width: 0;flex-grow: 1; word-break: break-all;flex-shrink: 1;-webkit-box-flex: 1;width: 60%;border-left: 1px solid #000000;box-sizing:border-box;padding:  10px 10px 10px 0.5%;font-size:10px;"
                                     :style="{width: printPar.goodsInf.name && printPar.goodsInf.attr && printPar.goodsInf.unitPrice ? '50%' : printPar.goodsInf.name && (!printPar.goodsInf.attr || !printPar.goodsInf.unitPrice) ? '75%' :'100%'}"
                                     v-if="printPar.goodsInf.name"
                                > {{good.name}}
                                </div>
                                <div style="min-width: 0;flex-grow: 1;padding:  10px 10px 10px 0.5%;flex-shrink: 1; word-break: break-all;-webkit-box-flex: 1;width: 40%;border-left: 1px solid #000000;box-sizing:border-box;padding-left: .5%;font-size:10px;"
                                     :style="
                                     {
                                         width: printPar.goodsInf.name && printPar.goodsInf.attr && printPar.goodsInf.unitPrice ? '25%' : !printPar.goodsInf.name && printPar.goodsInf.attr && printPar.goodsInf.unitPrice  ? '50%' : printPar.goodsInf.name && printPar.goodsInf.attr && !printPar.goodsInf.unitPrice ? '50%' : '100%'
                                         }"
                                     v-if="printPar.goodsInf.attr">{{good.attr}}
                                </div>
                                <div style="min-width: 0;flex-grow: 1;flex-shrink: 1;-webkit-box-flex: 1;width: 60%;border-left: 1px solid #000000;box-sizing:border-box;padding:  10px 10px 10px 0.5%;font-size:10px;"
                                     :style="{width: printPar.goodsInf.name && printPar.goodsInf.attr && printPar.goodsInf.unitPrice ? '25%' : !printPar.goodsInf.name && printPar.goodsInf.attr && printPar.goodsInf.unitPrice ? '50%' : printPar.goodsInf.name && !printPar.goodsInf.attr && printPar.goodsInf.unitPrice ? '50%' : '100%'}"
                                     v-if="printPar.goodsInf.unitPrice"
                                >￥{{good.unit_price}}
                                </div>
    ...
    const app = new Vue({
        ...
        methods: {
            handleDefault(row) {
                ...
                request({
                    params: {
                        r: 'mall/order-send-template/edit-default',
                    },
                    data: para,
                    method: 'post',
                }).then(e => {
                    if (e.data.code === 0) {
                        ...
                        if (row.is_default == 1) {
                            that.template_list.forEach(item => {
                                if (row.id != item.id) {
                                    item.is_default = 0;
                                }
                            })
                    ...
                    if (order_list[i].detailExpress.length > 0) {
                                    ...
                                    if (order_list[i].detailExpress[k].expressRelation[m].order_detail_id === detail[j].id) {
                                        for (let p = 0; p < new_detail.length; p++) {
                                            if (new_detail[p].id === order_list[i].detailExpress[k].expressRelation[m].order_detail_id) {
                                                ...
                                                this.$set(order_list[i].detailExpress[k].expressRelation[m], 'unit_price', new_detail[p].unit_price);
                        ...
                        for (let k = 0; k < order_list[i].detailExpress.length; k++) {
                            ...
                            for (let j = 0; j < order_list[i].detailExpress[k].expressRelation.length; j++) {
                                detail.push({
                                    ...
                                    unit_price: order_list[i].detailExpress[k].expressRelation[j].unit_price,
                        ...
                        for (let j = 0; j < order_list[i].detail.length; j++) {
                            detail.push({
                                ...
                                unit_price: order_list[i].detail[j].unit_price,
