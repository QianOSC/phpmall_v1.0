        ...
        <div class="form_box">
            <el-form :model="ruleForm" :rules="rules" size="small" ref="ruleForm" label-width="150px">
                    ...
                    <div>
                        <el-row>
                            <el-col :span="16">
                                ...
                                <el-form-item label="成为分销商的条件" required>
                                    <div>
                                        <el-radio-group v-model="ruleForm.become_condition">
                                            ...
                                            <el-radio :label="4">累计消费</el-radio>
                                    ...
                                    <div v-if="ruleForm.become_condition == 4">
                                        <el-form-item prop="total_consume">
                                            <el-input type="number" v-model.number="ruleForm.total_consume">
                                                <template slot="prepend">消费金额</template>
                                                <template slot="append">元</template>
                                            </el-input>
                                        </el-form-item>
                                ...
                                <el-form-item v-if="ruleForm.become_condition != 3" label="消费条件" required>
                                    <div>
                                        <el-radio-group v-model="ruleForm.consume_condition">
                ...
                <el-card style="margin-top: 10px" shadow="never">
                    ...
                    <el-col :span="14">
                        <el-form-item label="自定义默认等级名称" prop="default_level_name">
                            <el-input maxlength="6" placeholder="最多输入6个字符" v-model="ruleForm.default_level_name"></el-input>
                        </el-form-item>
        ...
        data() {
            ...
            return {
                ...
                rules: {
                    ...
                    total_consume: [
                        {type: 'number', message: '累计消费自动成为分销商金额必须为数字', trigger: 'blur'},
                    ],
                    pay_type: [
                        {message: '请选择提现方式', required: true}
                    ],
                    default_level_name: [
                        {message: '必须填写名称', required: true},
                    ],
                    cash_max_day: [
        ...
        methods: {
            ...
            loadData() {
                ...
                request({
                    ...
                    this.loading = false;
                    if (e.data.code == 0) {
                        if(!e.data.data.list.form) {
                            e.data.data.list.form = [];
                        }
