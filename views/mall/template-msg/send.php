...
<div id="app" v-cloak>
    <el-card v-loading="cardLoading" style="border:0" shadow="never"
                    ...
                    <el-form-item>
                        <el-col :span="14">
                            <el-tag style='border:0;width: 49%;min-width: 380px;margin-right: 10px;margin-bottom: 10px'
                                    type="danger">注意：群发模板消息有被封号的风险，请谨慎使用！
                            </el-tag>
                            <el-tag style='border:0;width: 49%;min-width: 380px;' type="danger">
                                注意：模板消息只发送给7天内在小程序内点击过的活跃用户
                            </el-tag>
                        </el-col>
                    </el-form-item>
        ...
        <el-dialog title="发送模板消息" :visible.sync="progressVisible">
            ...
            methods: {
                ...
                destroyTemplate(index) {
                    ...
                    self.$confirm('删除该条模板, 是否继续?', '提示', {
                        ...
                        request({
                            params: {
                                r: 'mall/template-msg/destroy-template'
                            },
                            method: 'post',
                            data: {
