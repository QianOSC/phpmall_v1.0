...
<div id="app" v-cloak>
    <el-card shadow="never" style="border:0" body-style="background-color: #f3f3f3;padding: 10px 0 0;"
        ...
        <el-form :model="ruleForm" :rules="rules" size="small" ref="ruleForm" label-width="150px">
                        ...
                        <div class="top-box">
                            <div :style="{'background-image':'url('+ruleForm.top_pic_url+')'}"
                                ...
                                <div flex="cross:center">
                                    <div class="head"></div>
                                    <span style="margin-left: 10px;" :style="{color: ruleForm.user_name_color}">用户昵称</span>
                                </div>
                            </div>
                        ...
                        <el-table class="table-info" :data="list" border style="width: 100%" v-loading="listLoading">
                            ...
                            <el-table-column label="用户端">
                                <template slot-scope="scope">
                                    <img style="margin: 0 3px;width: 24px;height: 24px;" v-for="item in scope.row.platform" :key="item.icon" :src="item.icon" alt="">
                                </template>
                            </el-table-column>
                            <el-table-column label="操作" width="240">
                                <template slot-scope="scope">
                                    <el-tooltip  v-if="activeName == 'all'" class="item" effect="dark" content="编辑" placement="top">
                                        <el-button circle type="text" size="mini" @click="edit(scope.row)">
                                            <img src="statics/img/mall/edit.png" alt="">
                                        </el-button>
                                    </el-tooltip>
                                    <el-tooltip  v-if="activeName == 'all'" class="item" effect="dark" content="设置用户端" placement="top">
                                        <el-button circle type="text" size="mini" @click="settingIndex(scope.row)">
                                            <img src="statics/img/plugins/setting.png" alt="">
                                        </el-button>
                                    </el-tooltip>
                                    <el-tooltip  v-if="activeName == 'all'" class="item" effect="dark" content="移入回收站" placement="top">
                                        <el-button circle type="text" size="mini" @click="toOperate(scope.row, 'recycle')">
                                            <img src="statics/img/mall/del.png" alt="">
                                        </el-button>
                                    </el-tooltip>
                                    <el-tooltip  v-if="activeName == 'recycle'" class="item" effect="dark" content="恢复" placement="top">
                                        <el-button circle type="text" size="mini" @click="toOperate(scope.row, 'resume')">
                                            <img src="statics/img/mall/order/renew.png" alt="">
                                        </el-button>
                                    </el-tooltip>
                                    <el-tooltip  v-if="activeName == 'recycle'" class="item" effect="dark" content="删除" placement="top">
                                        <el-button circle type="text" size="mini" @click="toOperate(scope.row, 'delete')">
                                            <img src="statics/img/mall/del.png" alt="">
                                        </el-button>
                                    </el-tooltip>
                                </template>
                ...
                <div v-if="id > 0 || newCreate" class="form-body">
                    ...
                    <el-card shadow="never" style="margin-bottom: 20px;min-width:500px" body-style="padding-right:30%">
                        ...
                        <el-form-item label="用户昵称文字颜色" prop="user_name_color">
                            <el-color-picker class="color-picker" size="small" v-model="ruleForm.user_name_color"></el-color-picker>
                        </el-form-item>
                    </el-card>
                    <el-card shadow="never" style="margin-bottom: 20px;min-width:500px" body-style="padding-right:30%">
                        <div slot="header">
            ...
            <el-button v-if="id > 0 || newCreate" class="button-item" :loading="btnLoading" type="primary" @click="store('ruleForm')" size="small">
                保存
            </el-button>
            <el-button v-if="id > 0 || newCreate" class="button-item" :loading="btnLoading" type="default" @click="reset" size="small">
                恢复默认
            </el-button>
        </el-form>
        ...
        <el-dialog :title="dialogFormType == 4 ? '收藏栏编辑': dialogFormType == 2 ? '我的账户编辑' : dialogFormType == 3 ? '菜单栏编辑' : '订单栏编辑'" :visible.sync="dialogFormVisible">
