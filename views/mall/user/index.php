            ...
            @selection-change="handleSelectionChange">
                ...
                <el-table-column label="操作" width="220"  fixed="right">
                    <template slot-scope="scope">
                        ...
                        <el-tooltip class="item" effect="dark" content="编辑积分" placement="top">
                        ...
                        <el-tooltip class="item" effect="dark" content="重置余额支付密码" placement="top">
...
<script>
    const app = new Vue({
        ...
        methods: {
            ...
            resetPassword(item) {
                this.$confirm('重置该用户支付密码, 是否继续?', '提示', {
