...
<div id="app" v-cloak>
    <el-card shadow="never" style="border:0" class="box-card" body-style="background-color: #f3f3f3;padding: 10px 0 0;">
        <div slot="header">
            <div>
                <span>{{preTitle}}小程序发布 微信小程序请用开发者工具导入项目，修改 siteinfo.js 并编译后上传，其他小程序（比如 头条和支付宝）前端代码直接在本后台下载后编译</span>
        ...
        <div class="table-body">
            <el-steps :active="step" finish-status="success" align-center style="border-bottom: 1px solid #ebeef5;padding-bottom: 20px">
                <el-step title="商城后台配置完所有参数，尽可能完整"></el-step>
                <el-step title="微信开发者工具导入项目，再本地编译"></el-step>
                <el-step title="满意后上传到微信审核发布为线上版本"></el-step>
            </el-steps>
            <div style="text-align: center; padding: 20px 0">
                <el-button type="primary" size="small" @click="getAppQrcode" :loading="app_qrcode_loading">获取小程序二维码
                </el-button>
